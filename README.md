...
2026-09-14 为第二款游戏加入本地开发 Web 版的实际游玩宣传片，保留真实游戏画面、音乐与音效，内容包含职业分支、路线、BP 增幅、弱点破防与战后选牌。视频为 43.032 秒、1280×800、30fps、H.264/AAC，3,566,913 bytes；仅剪掉等待，不使用虚构游戏画面。默认海报来自最终 MP4 的第一个解码帧。

- 视频：`eight-sages-tower-trailer-f5529cfd.mp4`，SHA-256 `f5529cfd0067b5883b42eb2b556a11b388d180d1182e4459f9478ec8ba362552`。
