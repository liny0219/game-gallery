...
- Keep 《月痕 · 迷途之森 / MOONWILD》 first, linked to `https://liny0219.github.io/moonwild/` and its matching GitHub repository. 《歧路 · 八贤之塔 / TOWER OF THE EIGHT》 is second, linked to `https://liny0219.github.io/eight-sages-tower/` and `https://github.com/liny0219/eight-sages-tower`. Both are playable. Do not restore the former name/repository or the obsolete `moonwild-play` URL.
