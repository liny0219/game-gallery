...
- Keep 《月痕 · 迷途之森 / MOONWILD》 first, linked to `https://liny0219.github.io/moonwild/` and its matching GitHub repository. 《歧路 · 八贤之塔 / TOWER OF THE EIGHT》 is second, linked to `https://liny0219.github.io/eight-sages-tower-play/` and `https://github.com/liny0219/eight-sages-tower-play`. Both are playable. The tower repository is a public Web build repository, not game source; label its link “构建仓库” and never direct visitors to the private source repository. Do not restore the former name/repository or the obsolete `moonwild-play` URL.
